...
async function check() {
    console.log('Checking jurnal_guru for NIP...');
    const { data, error } = await supabase.from('jurnal_guru').select('nama_guru, nip').limit(5);
    ...
    console.log('Jurnal Sample:', JSON.stringify(data, null, 2));
}
