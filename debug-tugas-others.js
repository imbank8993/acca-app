...
async function check() {
    console.log('Checking for other NIPs in jurnal_tugas_tambahan...');
    const { data } = await supabase.from('jurnal_tugas_tambahan').select('nip, kegiatan').neq('nip', '199309082019031013');
