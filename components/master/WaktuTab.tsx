    ...
    <div className="sk">
      ...
      <div className="sk__cards" aria-label="Daftar Waktu versi mobile">
        {loading ? (
          ...
          groupedMobile.map(([label, items]) => (
            <section key={`grp-${label}`} className="sk__group">
              <div className="sk__groupHead">
                <div className="sk__groupLeft">
                  <div className="sk__groupTitle">{label}</div>
                  <div className="sk__groupMeta">{items.length} slot</div>
                </div>
              </div>
